...
<div id="app">
    ...
    <div
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Mars Sekolah Santo Yoseph</li>
        </ol>
    </div>
    ...
    <main class="py-0">
        <div class="container">
            <div class="row">
                <h1 class="content-header">Mars Sekolah Santo Yoseph</h1>
            </div>
            <div class="row mb-3">
                <img class="image-mars" src="../images/mars.png" alt="">
            </div>
            <div class="row mb-4">
                <div class="col mars-item">
                    <ul>
                        <li><i class="fas fa-angle-right"></i><a href="../assets/mars_santo_yoseph.pdf">&nbsp;
                                File PDF Mars Santo Yoseph</a></li>
                        <li><i class="fas fa-angle-right"></i><a href="../assets/marssanyo.mp3">&nbsp;
                                Play Mars Santo Yoseph</a></li>
                    </ul>
                </div>
            </div>
        </div>
